Flow Chat [![License](http://img.shields.io/badge/license-MIT-lightgrey.svg?style=flat)][License] [![Flattr this](http://img.shields.io/badge/flattr-donate-lightgrey.svg?style=flat)][Donate] [![Build Status](http://img.shields.io/travis/flow/flow-chat/master.svg?style=flat)](https://travis-ci.org/flow/flow-chat) [![Coverage Status](http://img.shields.io/coveralls/flow/flow-chat/master.svg?style=flat)](https://coveralls.io/r/flow/flow-chat)
==================
Chat and messaging library for the Flow collection.

## Getting Started
* [Examples and code snippets](https://github.com/flow/examples/tree/master/chat)
* [Official documentation](#documentation)
* [IRC support chat](http://kiwiirc.com/client/irc.esper.net/flow)
* [Issues tracker](https://github.com/flow/flow-chat/issues)

## Source Code
The latest and greatest source can be found here on [GitHub](https://github.com/flow/flow-chat). If you are using Git, use this command to clone the project:

    git clone git://github.com/flow/flow-chat.git

Or download the [latest zip archive](https://github.com/flow/flow-chat/archive/master.zip).
...
* [com.flowpowered:flow-permissions](https://oss.sonatype.org/#nexus-search;gav~com.flowpowered~flow-permissions~~~)
...
If you'd prefer to manually import the latest .jar file, you can get it [here](https://github.com/flow/flow-chat/releases).

## Documentation
Want to get friendly with the project and put it to good use? Check out the latest [Javadocs](http://chat.flowpowered.com/).
...
## Legal Stuff
Flow Chat is licensed under the [MIT License][License]. Basically, you can do whatever you want as long as you include the original copyright. Please see the `LICENSE.txt` file for details.
...
[Donate]: https://flattr.com/submit/auto?user_id=spout&url=https://github.com/flow/flow-chat&title=Flow+Chat&language=Java&tags=github&category=software
